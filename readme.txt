...
* fixed : help button issue.
* update : allow 100+ widgets to the sidebar.

= 3.7.22 August 26th 2022 =
* update : disabled auto load google fonts.
...
* checked : [WP 5.9] Hueman successfully tested with WordPress 5.9-beta4 
